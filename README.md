...
This is a basic AWS lambda deployed with serverless framework to log third party callbacks requests with AWS CloudWatch logs 

#### Note: AWS provider keys must be provided.
